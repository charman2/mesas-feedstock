...
Documentation: https://mesas.readthedocs.io/

mesas is a suite of tools for analyzing tracer data and modeling solute
transport in time-variable input-output flow systems using StorAge
Selection (SAS) functions. As of v2 it is written in pure Python; the
numerical solver is JIT-compiled with Numba (no Fortran compiler
required). Pre-release builds are published to the mesas_dev label:
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/mesas-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/mesas-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
It is possible to list all of the versions of `mesas` available on your platform:
